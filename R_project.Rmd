...
We'll create an installation guide for R and RStudio (based on this one: <https://iqss.github.io/dss-workshops/Rinstall.html>), together with packages that need to be installed, so that all participants can arrive with working R environments.
